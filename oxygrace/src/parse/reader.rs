...
fn apply_axis(axis: &mut crate::model::Axis, prop: AxisProp) {
    match prop {
        ...
        AxisProp::TicksInOut(n) => axis.tick_inout = n,
        ...
        AxisProp::TlStagger(n) => axis.tl_stagger = n.max(0),
...
fn apply_set(set: &mut crate::model::Set, prop: SetProp) {
    ...
    match prop {
        ...
        SetProp::EbOn(b) => set.errbar.active = b,
        SetProp::EbPlace(n) => set.errbar.place = n,
        SetProp::EbColor(n) => set.errbar.color = n,
        SetProp::EbSize(v) => set.errbar.size = v,
        SetProp::EbLinewidth(v) => set.errbar.linewidth = v,
        SetProp::EbLinestyle(n) => set.errbar.linestyle = n,
        SetProp::EbRiserLinewidth(v) => set.errbar.riser_linewidth = v,
        SetProp::EbRiserLinestyle(n) => set.errbar.riser_linestyle = n,
        SetProp::EbRiserClip(b) => set.errbar.arrow_clip = b,
        SetProp::EbRiserClipLen(v) => set.errbar.cliplen = v,
